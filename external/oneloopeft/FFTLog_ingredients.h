...
void FFT_compute_coeff(struct background * pba, struct primordial * ppm, struct fourier * pfo, double z, struct fft_struct *fft_input, int rsd_ir_switch, long SPLIT, long hm_switch);
