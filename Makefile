...
EXTERNAL += ps_halo_1loop.o utilities.o cosmology.o IR_res.o wnw_split.o pspec_FFTLog_real.o pspec_FFTLog_rsd.o FFTLog_ingredients.o FFTLog_matter_real.o FFTLog_galaxy_real.o FFTLog_galaxy_rsd.o
...
class: $(TOOLS) $(SOURCE) $(EXTERNAL) $(OUTPUT) $(CLASS)
	$(CC) $(OPTFLAG) $(OMPFLAG) $(LDFLAG) -o class $(addprefix build/,$(notdir $^)) -lm -L./$(ONELOOPEFT)/library/Cuba-4.2.1 -lcuba -lgsl -lgslcblas -lfftw3
